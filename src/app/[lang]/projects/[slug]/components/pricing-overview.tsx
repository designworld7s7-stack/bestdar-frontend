...
import { ChevronDown, Maximize2, Layers, Eye, Check, Info } from 'lucide-react';

export default function PricingOverview({ lang, units = [], onUnitSelect, selectedUnitId }: any) {
  const isAr = lang === 'ar';
  
  // Ensure units is always an array to prevent crashes
  ...
  return (
    <section className="w-full max-w-[1440px] mx-auto py-12 lg:py-20 px-4 lg:px-12 bg-white relative z-10 border-t border-gray-100">
      ...
      <div className="bg-white rounded-[32px] lg:rounded-[40px] shadow-[0_30px_70px_rgba(0,0,0,0.03)] overflow-hidden border border-gray-50">
