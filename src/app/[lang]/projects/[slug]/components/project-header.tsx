...
<div className="flex flex-wrap items-center gap-x-10 gap-y-6 text-[#0A0A0A] mt-10 border-t border-gray-100 pt-8">
  ...
  {/* Price: Highlighted as the most important info */}
  <div className="flex items-center gap-3">
    ...
    <div className="flex flex-col">
      <span className="text-[10px] text-gray-400 uppercase font-bold tracking-widest">Starting Price</span>
  ...
  {/* Project ID: Bold and clearly defined */}
  <div className="flex items-center gap-3">
    <div className="bg-gray-100 p-2 rounded-full">
      <Hash size={18} strokeWidth={2.5} className="text-gray-500" />
    </div>
    <div className="flex flex-col">
      <span className="text-[10px] text-gray-400 uppercase font-bold tracking-widest">Reference</span>
  ...
  /* Removed font-medium and wide tracking. Added font-bold and tracking-tight [cite: 2026-02-04] */
  className="btn-brand px-12 h-[52px] lg:h-[56px] text-[13px] font-bold uppercase tracking-tight transition-all hover:bg-black shadow-lg hover:shadow-xl active:scale-95"
>
