...
useEffect(() => {
 ...
 return (
  ...
  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
    ...
    {/* الجانب النصي والمعالم: يأخذ 5 أعمدة من أصل 12 (حوالي 40% من العرض) */}
    <div className="lg:col-span-5 flex flex-col justify-center space-y-10 order-2 lg:order-1">
      <div className="space-y-6">
        ...
        {/* إضافة leading-tight لتحسين مظهر العنوان الضخم */}
        ...
        <div className="relative">
          {/* إزالة max-w-xl لترك النص يتمدد في مساحته الجديدة */}
      ...
      {/* المعالم ستأخذ مساحتها الآن بدون ضغط */}
    ...
    {/* جانب الخريطة: يأخذ 7 أعمدة من أصل 12 (حوالي 60% من العرض) ليبقى كبيراً ومميزاً */}
